...
namespace Viriplaca.Identity.Data.Migrations
{
    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RedirectUris = table.Column<string>(
                        type: "nvarchar(1024)",
                        maxLength: 1024,
                        nullable: false
                    )
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodeChallenge = table.Column<string>(
                        type: "nvarchar(64)",
                        maxLength: 64,
                        nullable: true
                    ),
                    CodeChallengeMethod = table.Column<string>(
                        type: "nvarchar(16)",
                        maxLength: 16,
                        nullable: true
                    )
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "Client", schema: "Identity");

            migrationBuilder.DropTable(name: "FileResource", schema: "Common");

            migrationBuilder.DropTable(name: "Grant", schema: "Identity");

            migrationBuilder.DropTable(name: "LocaleResource", schema: "Common");

            migrationBuilder.DropTable(name: "PermissionLocale", schema: "Identity");

            migrationBuilder.DropTable(name: "RolePermission", schema: "Identity");

            migrationBuilder.DropTable(name: "UserRefreshToken", schema: "Identity");
